...
static PyObject *__pyx_pf_7sklearn_8manifold_6_utils__binary_search_perplexity(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_sqdistances, float __pyx_v_desired_perplexity, int __pyx_v_verbose) {
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_7sklearn_8manifold_6_utils__binary_search_perplexity(__pyx_v_sqdistances, __pyx_v_desired_perplexity, __pyx_v_verbose, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
